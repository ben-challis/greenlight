...
/**
 * Pure comparison of two coverage maps. Produces per-file percentage deltas
 * and newly uncovered lines for every file present in either map that
 * changed, plus the total percentage movement. Neither input is mutated and
 * comparing a map against itself yields an empty report.
 *
 * @internal
 */
