...
use Greenlight\Expect\ReturnValueExpectation;
...
/**
 * Gets extension matcher closure signatures.
...
final readonly class ExpectationMethodsExtension implements MethodsClassReflectionExtension
{
    ...
    public function hasMethod(ClassReflection $classReflection, string $methodName): bool
    {
        ...
        return $this->matcherMap->get()->has($methodName);
    }
