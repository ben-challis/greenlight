...
final class RunHeaderTest
{
    ...
    public function rendersTwoPlainLinesWhenEveryFieldIsPresent(): void
    {
        ...
        expect($header->render(11, new Style(ansi: false)))->because('renders two plain lines when every field is present')
    ...
    public function colorsTheNameGreenAndTheSeedDim(): void
    {
        ...
        expect($header->render(11, new Style(ansi: true)))->because('colors the name green and the seed dim')
    ...
    public function omitsTheSeedWhenAbsent(): void
    {
        ...
        expect($header->render(1, new Style(ansi: false)))->because('omits the seed when absent')
    ...
    public function rendersAZeroSeed(): void
    {
        ...
        expect($header->render(1, new Style(ansi: false)))
    ...
    public function flagsAMissingConfigFile(): void
    {
        ...
        expect($header->render(1, new Style(ansi: false)))->because('flags a missing configuration file')
            ->toBe("Greenlight dev-main\nPHP 8.4.0 | configuration: (none) | workers: 1");
        expect($header->render(1, new Style(ansi: true)))
    ...
    public function flagsTheWorkerFallback(): void
    {
        ...
        expect($header->render(1, new Style(ansi: true)))->because('flags the worker fallback')
    ...
    public function phpVersionDefaultsToCurrentPhpVersion(): void
    {
        ...
        expect($header->render(2, new Style(ansi: false)))->because('PHP version defaults to the current PHP version')->toContain('PHP ' . \PHP_VERSION);
    }
}
