...
final class ReportGenerationFailedTest
{
    ...
    {
        Expect::calling(static fn() => ReportGenerationFailed::because(" \n\t "))
            ->toThrow(
    ...
    {
        Expect::value(ReportGenerationFailed::writeFailed()->getMessage())
    ...
    {
        Expect::value(ReportGenerationFailed::unmappedEvent(self::class)->getMessage())
            ->toBe(\sprintf(
    ...
    {
        Expect::value(ReportGenerationFailed::xmlUnavailable()->getMessage())
