...
final class ReportGenerationFailedTest
{
    ...
    {
        expect(ReportGenerationFailed::writeFailed()->getMessage())
    ...
    {
        expect(ReportGenerationFailed::unmappedEvent(self::class)->getMessage())
            ->toBe(\sprintf(
    ...
    {
        expect(ReportGenerationFailed::xmlUnavailable()->getMessage())
