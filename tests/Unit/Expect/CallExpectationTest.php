...
final class CallExpectationTest
{
    ...
    public function temporalCallMatchersRetainTheMatchedOutcome(): void
    {
        ...
        ExpectationRuntime::withClock(new FakePollingClock(), static function () use (&$calls, $error): void {
    ...
    {
        $calls = 0;
        ExpectationRuntime::withClock(new FakePollingClock(), static function () use (&$calls): void {
    ...
    {
        ExpectationRuntime::withClock(new FakePollingClock(), static function (): void {
