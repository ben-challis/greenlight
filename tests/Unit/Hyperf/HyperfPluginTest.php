...
final readonly class HyperfPluginTest
{
    ...
    {
        expect(new HyperfPlugin('/project')->source())->toBeNull();
        expect(new HyperfPlugin('/project', source: 'application')->source())->toBe('application');
    }
    ...
    public function aServiceWithoutAnIdUsesTheParameterType(): void
    {
        ...
        expect($plugin->resolve(\ArrayObject::class, [new Service()]))->toBe($service);
    }
