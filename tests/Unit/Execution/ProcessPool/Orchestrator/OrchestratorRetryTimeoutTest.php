...
final readonly class OrchestratorRetryTimeoutTest
{
    ...
    public function eachRetryGetsANewHardTimeoutDeadline(): void
    {
        ...
        Expect::value($sink->results()[0]->attempts)->toBe(40);
    ...
    public function aBlockedRetryStillReachesItsHardTimeout(): void
    {
        ...
        Expect::value($sink->results()[0]->attempts)->toBe(2);
        Expect::value($sink->results()[0]->failures[0]->message)->toContain('exceeded its 0.100-second time limit');
        Expect::value($sink->results()[0]->durationSeconds)->toBeGreaterThan(2.3);
        Expect::value($sink->results()[0]->failures[0]->message)->toContain('after 2.400 seconds');
    }
