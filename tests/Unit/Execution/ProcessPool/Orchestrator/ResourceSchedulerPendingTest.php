...
final class ResourceSchedulerPendingTest
{
    ...
    public function clearingPendingWorkPreservesActiveLeasesAndAllowsRequeue(): void
    {
        ...
        Expect::value($scheduler->pendingCount())
        ...
        Expect::value($scheduler->pendingCount())
            ...
            ->toBe(0);
        Expect::value($scheduler->dispatch(true)->kind)->toBe(DispatchKind::Drain);
        ...
        Expect::value($scheduler->pendingCount())
            ...
            ->toBe(1);
        Expect::value(SchedulingFixture::assignedLease($scheduler, freshWorker: false)->unit)->toBe($queued);
        Expect::value($scheduler->pendingCount())->toBe(0);
    }
}
