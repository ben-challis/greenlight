...
final readonly class ExcludeSelectionTest
{
    ...
    public function excludeClassRemovesOnlyTheMatchingClass(): void
    {
        ...
        Expect::value($result->exitCode)->because('exclude class removes only the matching class')->toBe(0);
        Expect::value($this->selectedTestIds($result->stdoutLines()))
    ...
    public function excludeClassAcceptsAWildcard(): void
    {
        ...
        Expect::value($result->exitCode)->because('exclude class accepts a wildcard')->toBe(0);
        Expect::value($this->selectedTestIds($result->stdoutLines()))
    ...
    public function excludePathRemovesTestsUnderThatPrefix(): void
    {
        ...
        Expect::value($result->exitCode)->because('exclude path removes tests under that prefix')->toBe(0);
        Expect::value($this->selectedTestIds($result->stdoutLines()))
    ...
    public function excludePathResolvesARelativePrefixAgainstTheWorkingDirectory(): void
    {
        ...
        Expect::value($result->exitCode)->because('exclude path resolves a relative prefix against the working directory')->toBe(0);
        Expect::value($this->selectedTestIds($result->stdoutLines()))
    ...
    public function excludePathResolvesARelativeDirectoryPrefix(): void
    {
        ...
        Expect::value($result->exitCode)->because('exclude path resolves a relative directory prefix')->toBe(0);
        Expect::value($this->selectedTestIds($result->stdoutLines()))
    ...
    public function excludePathWarnsWhenThePrefixMatchesNoTestFile(): void
    {
        ...
        Expect::value($result->exitCode)->because('exclude path warns when the prefix matches no test file')->toBe(0);
        Expect::value($result->output())
    ...
    public function excludePathDoesNotWarnWhenThePrefixMatchesATestFile(): void
    {
        ...
        Expect::value($result->exitCode)->because('exclude path does not warn when the prefix matches a test file')->toBe(0);
        Expect::value($result->output())
