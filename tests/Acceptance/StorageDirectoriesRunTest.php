        ...
        $project->writeFile('tests/StorageProbeTest.php', <<<'PHP'
            ...
            final readonly class StorageProbeTest
            {
                ...
                public function usesWorkerStorage(): void
                {
                    ...
                    expect($double)->toBeInstanceOf(Collaborator::class);
                }
            }
